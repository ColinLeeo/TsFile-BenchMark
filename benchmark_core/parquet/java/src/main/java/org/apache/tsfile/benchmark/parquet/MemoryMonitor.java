...
public class MemoryMonitor {
    ...
    private static final String CSV_FILE = "memory_usage_parquet_java.csv";
    private BufferedWriter writer;
    private int iter = 0;

    public MemoryMonitor() throws IOException {
        writer = Files.newBufferedWriter(
                Paths.get(CSV_FILE), StandardOpenOption.CREATE, StandardOpenOption.TRUNCATE_EXISTING);
    ...
    public long get_memory_usage() {
        ...
        return currentProcess.getResidentSetSize() / 1024;
    }
